...
<body>
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				style="background: 	#E6E6FA; padding: 40px 150px; margin: 70px; border: 8px solid #ccc;">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" width="100" value="注册" name="submit"
								style="background: url('./images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0); height: 35px; width: 100px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已有账号，<a href="login.jsp">马上登录</a>
						</div>
